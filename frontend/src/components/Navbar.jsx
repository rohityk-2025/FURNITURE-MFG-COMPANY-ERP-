...
export default function Navbar({ onMenuClick }) {
  ...
  const [company, setCompany] = useState(() => {
    try {
      return JSON.parse(localStorage.getItem("erp_company") || "{}");
    } catch {
      return {};
    }
  });
              ...
              return (
                <div key={type}>
                  ...
                  {g.map((item, i) => (
                    ...
                    >
                      <span
                        className={`badge-${type === "order" ? "blue" : type === "customer" ? "green" : "purple"}`}
                        style={{ fontSize: 10 }}
                      >
                        {type}
                      </span>
      ...
      >
        ...
        <div style={{ position: "relative" }} ref={actRef}>
          ...
          >
            ...
            <span style={{ display: "none" }} className="new-label">
              New
            </span>
          ...
          {showProf && (
            ...
            >
              ...
              >
                ...
                <span
                  className={`badge-${user?.role === "ADMIN" ? "blue" : "purple"}`}
                  style={{
                    marginTop: 5,
